$(document).ready(function () {
    ...
    $('#empForm input[type="text"]').tooltipster({
        trigger: 'custom',
        onlyOne: false,
        position: 'right'
    });
    
    $('#empForm input[type="date"]').tooltipster({
        trigger: 'custom',
        onlyOne: false,
        position: 'right'
    });
    
    $('#empForm input[type="radio"]').tooltipster({
        trigger: 'custom',
        onlyOne: false,
        position: 'right'
    });
    
    $('#empForm select').tooltipster({
        trigger: 'custom',
        onlyOne: false,
        position: 'right'
    });
    ...
    $('#empForm').validate({
    	...
    	messages: {
    		id: {
    			required: "Please enter employee's ID",
    			digits: "Invalid ID",
    			maxlength: "ID is too long (max 11 digits)"
    		},
    		name: {
